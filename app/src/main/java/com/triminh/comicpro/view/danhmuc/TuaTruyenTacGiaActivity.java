...
public class TuaTruyenTacGiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(ComicPro.objTacgia.getTacgia());
    ...
    public void GetTuaTruyen() {
        ApiTacGia.apiTacGia.GetTuaTruyen(ComicPro.objTacgia.getMatacgia()).enqueue(new Callback < List < TuaTruyen > >() {
            @Override
