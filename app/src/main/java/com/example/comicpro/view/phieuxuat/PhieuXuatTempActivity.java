package com.example.comicpro.view.phieuxuat;
...
import com.example.comicpro.adapter.phieunhap.Adapter_PhieuNhapTemp;
        ...
        ApiNhapXuatTemp.apiNhapXuatTemp.NhapXuatTemp("GET_DATA", 0, "", 0, 0.0,  "",1,"","").enqueue(new Callback < List < NhapXuatTemp > >() {
            ...
            public void onResponse(Call < List < NhapXuatTemp > > call, Response < List < NhapXuatTemp > > response) {
                ...
                if (nhapXuatTemps.size() > 0) {
                    ...
                    TM_Toast.makeText(PhieuXuatTempActivity.this, "Không tồn tại đơn hàng để thanh toán.", TM_Toast.LENGTH_LONG, TM_Toast.WARNING, false).show();
                }
            }
